module Contracts
  class UpdateService < ::BaseService
    ...
    def action
      assign_other_files
      contract.assign_attributes(contract_attributes.except(:other_files))
    ...
    private
      ...
      def assign_other_files
        return unless contract_attributes[:other_files].present?
        contract_attributes[:other_files].each do |other_file|
          contract.other_files.attach(other_file)
        end
      end
